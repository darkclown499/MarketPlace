...
export default function SearchScreen() {
  ...
  }, [query, selectedCategory, maxPrice, condition, history]);
      ...
      <View style={[styles.header, { backgroundColor: colors.primary }]}>
        ...
        <View style={[styles.searchBar, { backgroundColor: colors.surface, ...Shadow.sm, flexDirection: isRTL ? 'row-reverse' : 'row' }]}>
          ...
          <TextInput
            ...
            value={query}
            onChangeText={v => { setQuery(v); if (!v) setHasSearched(false); }}
        ...
        <View style={[styles.historyPanel, { backgroundColor: colors.surface, borderColor: colors.border, ...Shadow.md }]}>
          ...
          {history.map((item, i) => (
            ...
            >
              ...
              <Text style={[styles.historyItemText, { color: colors.textPrimary, textAlign: isRTL ? 'right' : 'left' }]} numberOfLines={1}>
                {item}
              </Text>
              <Pressable
                onPress={() => {
              ...
              {([null, 'new', 'used'] as (Condition)[]).map(c => {
                ...
                return (
                  ...
                  >
                    {c !== null ? (
                      <MaterialIcons
                        name={c === 'new' ? 'fiber-new' : 'recycling'}
                        size={14}
...
const styles = StyleSheet.create({
  ...
  searchBar: {
    ...
    borderRadius: Radius.lg, paddingHorizontal: Spacing.md, height: 46, gap: Spacing.sm,
  },
  ...
  priceInput: {
    flex: 1, height: 46, borderWidth: 1.5,
