...
export const CHAT_POLL_INTERVAL = 2000; // ms — conversation list polling (reduced for faster unread updates)
export const READ_RECEIPT_INTERVAL = 1500; // ms — active chat polling (fast read-receipt sync)
